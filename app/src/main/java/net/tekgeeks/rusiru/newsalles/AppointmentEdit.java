...
public class AppointmentEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appo_id=intent.getStringExtra("Appo_ID");
        ...
        mAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mTitle.getText().toString().equals("")||mDes.getText().toString().equals("")||mTime.getText().toString().equals("")){
                    ...
                    Toast.makeText(AppointmentEdit.this, "Please fill all the fields",Toast.LENGTH_SHORT).show();
                }else {
                    String date_time= mDate.getText().toString()+" "+mTime.getText().toString();
                    Button cl= (Button) findViewById(R.id.btnGoCalendar);
                    cl.setText(userid);
                    BackgroundTask backgroundTask=new BackgroundTask(AppointmentEdit.this);
                   backgroundTask.execute("appointmentUpdate",userid.toString(),date_time.toString(),mTitle.getText().toString(),mDes.getText().toString(),CurrentDate.toString(),appo_id.toString());
    ...
    protected Dialog onCreateDialog(int id){
        if(id==DIALOG_ID) {
            return new TimePickerDialog(AppointmentEdit.this, kTimePickerListner, hour_X, minute_X, false);
        }
